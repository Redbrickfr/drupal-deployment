...
namespace Drupal\mapgeofr\Form;
...
class RegionSelector extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if($city = $form_state->getValue('department')){
      $response = GeoApiFr::getInstance()->get('communes', ['codeDepartement' => $city]);
  ...
  public function AjaxLoadDepartements(array &$form, FormStateInterface $form_state){
      ...
      $form['dp_wrapper']['department']['#options'] = $department_list;
      $form['dp_wrapper']['department']['#access'] = TRUE;
  ...
  public function AjaxLoadCommunes(array &$form, FormStateInterface $form_state){
      ...
      $form['c_wrapper']['commune']['#options'] = $communes_list;
      $form['c_wrapper']['commune']['#access'] = TRUE;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('mapgeofr.geo_controller_commune', ['code_commune' => $form_state->getValue('commune')]);
  }
